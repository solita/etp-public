    ...
    <div class="icon-container relative">
      ...
      <div class="info-popup">
        ...
        <p>
          ...
          jossa laskennallisen kokonaisenergiankulutuksen laskemiseen käytetään
          kuukausitason laskentamenetelmää. Tyypillinen tällainen rakennus on
          esimerkiksi omakotitalo.
        </p>
      </div>
    </div>
  </div>
          ...
          <tr>
            ...
            <td data-title="Email">
              <a href="mailto:{laatija.email}" title={laatija.email}>
                <img class="icon md:mx-auto" src={IconMail} alt="Email icon" />
              </a>
            </td>
