...
<div class="px-4 lg:px-8 xl:px-16 pt-8 pb-4 mx-auto">
  ...
  <p>
    Soveltuu esimerkiksi lainoja ja vakuuksia antavien tahojen käyttöön, joilla
    on oikeus käsitellä henkilötietoja.
  </p>
  ...
  <p>
    ...
    kyseisellä postinumeroalueella löytyy vähemmän kuin 4 rakennusta
    rekisteristä.
  </p>
